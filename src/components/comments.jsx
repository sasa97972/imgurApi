                        ...
                        <div key={comment.id} className="gallery-comment__container">
                            <div className="gallery-comment">
                                ...
                                <div className="gallery-comment__info">
                                    <p className="gallery-comment__info-text">Points: {comment.points}</p>
                            ...
                            <div className="gallery-comment__replies-container">
                                ...
                                <div className="gallery-comments gallery-comment__replies">
                                    {comment.children.map((replie) => {
                                        return(
                                            <div key={replie.id} className="gallery-comment gallery-comment__replies-comment">
                                                <p className="gallery-comment__author">{replie.author}</p>
                                                <p className="gallery-comment__text">{replie.comment}</p>
                                            </div>
                                        );
                                    })}
                                </div>
    ...
    render() {
        ...
        return(
            ...
            className="gallery-comment__button">
                {this.state.open ?  `Hide replies (${count})`  : `Show replies (${count})`}
            </div>
        );
    }
}
